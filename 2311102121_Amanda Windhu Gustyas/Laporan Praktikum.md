...
### KESIMPULAN
Rekursif adalah metode pemrograman yang menyelesaikan masalah dengan memecahnya menjadi sub-masalah yang lebih kecil, di mana suatu fungsi memanggil dirinya sendiri hingga mencapai kondisi penghentian yang disebut base-case. Base-case sangat penting karena memastikan proses rekursif berhenti pada kondisi tertentu, sedangkan recursive-case adalah bagian yang memungkinkan fungsi terus memanggil dirinya sendiri selama kondisi base-case belum terpenuhi. Rekursif juga bisa menjadi alternatif untuk perulangan (loop), dengan catatan setiap algoritma rekursif dapat digantikan oleh algoritma iteratif yang memiliki fungsi serupa.
